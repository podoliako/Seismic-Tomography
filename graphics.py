...
from utilities import time, np, generate_name
from scipy.stats import ttest_ind
from utilities import pd, np, os
...
def plot_events_stations(events_df, stations_df, edges_df):
    """
    ...
    plt.savefig('events-statins.png')
